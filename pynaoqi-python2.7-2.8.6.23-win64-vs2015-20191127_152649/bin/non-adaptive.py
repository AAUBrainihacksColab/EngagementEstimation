...
gesture.post.say(introduction_2)
...
width=67, height=2, bg="#81C784",fg="#212121", font=("calibri", 17, "bold"))
# place of the title
title.place(x=0, y=2)
...
with open('Roila_Trial2.txt') as currentline:
...
count = 0
#Loop dict
#we need recording of all 45 we have 20 here, 20 other file
